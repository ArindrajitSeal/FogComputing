...
class CrashDBTest{
	public int m(String img)throws Exception{
		...
		Process p = Runtime.getRuntime().exec("/root/darknet/darknet detector test /root/darknet/cfg/obj.data /root/darknet/cfg/yolov3-tiny-sumanta.cfg /root/darknet/backup/yolov3-tiny-sumanta_53100.weights "+img+" -dont_show");
		int i = p.waitFor();
		if(i==0)
