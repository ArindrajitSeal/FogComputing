...
class CocoDBTest{
	public static void main(String[]args)throws Exception{
		...
		Process p = Runtime.getRuntime().exec("/root/darknet/darknet detector test /root/darknet/cfg/coco.data /root/darknet/cfg/yolov3.cfg /root/darknet/yolov3.weights "+args[0]+" dont_show");
		int i = p.waitFor();
